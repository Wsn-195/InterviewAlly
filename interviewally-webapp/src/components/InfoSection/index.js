...
import { Column1, Column2, Heading, ImgWrap, InfoContainer, InfoRow, InfoWrapper, TextWrapper, TopLine ,SubTitle, BtnWrap, Img} from './InfoElement'

const InfoSection = ({lightBg,id,imgStart,topLine,lightText,headline,darkText,description,buttonLabel,img,alt,primary,dark,dark2}) => {
  console.log("Info dfata");
  console.log(alt);
